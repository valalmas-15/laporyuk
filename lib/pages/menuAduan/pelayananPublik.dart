...
class PelayananPublik extends StatefulWidget {
  @override
  _PelayananPublikPageState createState() => _PelayananPublikPageState();
}

class _PelayananPublikPageState extends State<PelayananPublik> {
  ...
  List<String> _dropdownItems = ['Layanan Publik 1', 'Layanan Publik 2', 'Layanan Publik 3'];
  ...
  void _submitForm() {
    ...
    if (_selectedDropdownItem != null) {
      print('Layanan Publik Terkait: $_selectedDropdownItem');
    }
